...
public class ExtGenericFastJsonRedisSerializer extends GenericFastJsonRedisSerializer {
    ...
    {
        int features = SerializerFeature.config(JSON.DEFAULT_GENERATE_FEATURE, SerializerFeature.SkipTransientField,
                false);
