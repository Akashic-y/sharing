...
public class JsonUtil {
    ...
    public static void main(String[] args) {
        ...
        resultMap.put("name", "pmanager");
        resultMap.put("option", "event");
        resultMap.put("room", "81166");
        Map<String, Object> scoreMap = new HashMap<String, Object>();
        scoreMap.put("left_score", 1);
        scoreMap.put("right_score", 0);
        resultMap.put("score", JsonUtil.toJson(scoreMap));

        Map<String, Object> contentMap = new HashMap<String, Object>();
        contentMap.put("part", "下半场");
        contentMap.put("time", "01分06秒");
        contentMap.put("team", "host");
        contentMap.put("player_id", "155735");
        contentMap.put("number", "6");
        contentMap.put("name", "刘秀丽");
        contentMap.put("event", "点球罚进");
        contentMap.put("option", "event");
        contentMap.put("node", "second");
        contentMap.put("event_type", "penalty");
        contentMap.put("amount", "1");
        contentMap.put("uuid", "0c554f3736bf420e8fbdc4b1c1b778ad");
        resultMap.put("content", JsonUtil.toJson(contentMap));
